...
import { Specifications } from "../order-specifications/Specifications";
import { SpecificationsUIProvider } from "../order-specifications/SpecificationsUIContext";
import { useSubheader } from "../../../../../../_metronic/layout";
import { ModalProgressBar } from "../../../../../../_metronic/_partials/controls";
import { RemarksUIProvider } from "../order-remarks/RemarksUIContext";
import { Remarks } from "../order-remarks/Remarks";
...
export function OrderEdit({
  ...
  useEffect(() => {
    ...
    if (productForEdit && id) {
      _title = `Edit Order '${productForEdit.weight} ${productForEdit.price}'`;
    }
