      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        >
          <NavLink className="menu-link menu-toggle" to="/e-commerce/customers">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Shopping/user2.svg")} />
            </span>
          ...
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/e-commerce/drivers">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Shopping/driver2.svg")} />
            </span>
        ...
        >
          <NavLink className="menu-link menu-toggle" to="/e-commerce/products">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Shopping/deliverybox.svg")} />
            </span>
